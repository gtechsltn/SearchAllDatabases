...
# SP: SearchAllTables: Demo (tested)
```
EXEC dbo.SearchAllTables @SearchStr = N'haha';
```
...
EXEC sys.sp_MS_marksystemobject sp_FindStringInTable_with_flag 'Irv%', 'Person', 'Address' 
GO
```
